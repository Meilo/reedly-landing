...
const T = {
  fr: {
    ...
    "proof.stat1":
      "Plus rapide que la rédaction manuelle d'un compte-rendu terrain",
    "proof.stat2":
    ...
    "pricing.pro.feat2": "Jusqu'à 45 min d'enregistrement par rendez-vous",
    "pricing.pro.feat3": "Rapports structurés après chaque rendez-vous",
    "pricing.pro.feat4": "Synthèses stratégiques sur plusieurs rapports",
    "pricing.pro.feat5": "Max — assistant IA pour interroger vos données",
    "pricing.pro.feat6": "Hub web — visibilité équipe complète",
    "pricing.pro.feat7": "80 crédits IA / mois par utilisateur",
    "pricing.pro.feat8": "Support email",
    "pricing.pro.notIncludedLabel": "Non inclus",
    "pricing.pro.missing1": "Distinction vocale",
    "pricing.pro.missing2": "Analyse IA croisée équipe",
    "pricing.pro.missing3": "Intégration CRM (Axonaut, HubSpot…)",

    "pricing.team.badge": "Recommandé",
    "pricing.team.plan": "Équipe",
    "pricing.team.per": "par utilisateur par mois",
    "pricing.team.feat1": "Tout le plan Pro Team inclus",
    "pricing.team.plusLabel": "En plus de Pro Team",
    "pricing.team.feat2": "Jusqu'à 2h d'enregistrement (vs 45 min)",
    "pricing.team.feat3": "Distinction vocale (qui parle quand)",
    "pricing.team.feat4": "Analyse IA croisée de toute l'équipe",
    "pricing.team.feat5": "Intégration CRM (Axonaut, HubSpot…)",
    "pricing.team.feat6": "450 crédits IA / mois (vs 80)",
    "pricing.team.feat7": "Support prioritaire sous 24h",

    "pricing.enterprise.plan": "Entreprise",
    "pricing.enterprise.price": "Sur devis",
    "pricing.enterprise.feat1": "Tout le plan Équipe inclus",
    "pricing.enterprise.plusLabel": "En plus d'Équipe",
    "pricing.enterprise.feat2": "Volume de crédits IA sur mesure (vs 450)",
    "pricing.enterprise.feat3": "Vocabulaire métier custom",
    "pricing.enterprise.feat4": "Multi-équipes / multi-secteurs",
  ...
  en: {
    ...
    "proof.stat2":
      "Of discussed points captured — objections, commitments, next steps",
    "proof.stat3": "To get a complete structured report after recording ends",
    "proof.stat4":
      "Audio data retained — audio is deleted once generation is complete",
    ...
    "pricing.pro.feat2": "Up to 45 min of recording per meeting",
    "pricing.pro.feat3": "Structured reports after every meeting",
    "pricing.pro.feat4": "Strategic syntheses across multiple reports",
    "pricing.pro.feat5": "Max — AI assistant to query your data",
    "pricing.pro.feat6": "Web Hub — full team visibility",
    "pricing.pro.feat7": "80 AI credits / month per user",
    "pricing.pro.feat8": "Email support",
    "pricing.pro.notIncludedLabel": "Not included",
    "pricing.pro.missing1": "Voice diarization",
    "pricing.pro.missing2": "Cross-team AI analysis",
    "pricing.pro.missing3": "CRM integration (Axonaut, HubSpot…)",

    "pricing.team.badge": "Recommended",
    "pricing.team.plan": "Team",
    "pricing.team.per": "per user per month",
    "pricing.team.feat1": "Everything in Pro Team",
    "pricing.team.plusLabel": "Plus, on top of Pro Team",
    "pricing.team.feat2": "Up to 2h of recording (vs 45 min)",
    "pricing.team.feat3": "Voice diarization (who said what)",
    "pricing.team.feat4": "Cross-team AI analysis",
    "pricing.team.feat5": "CRM integration (Axonaut, HubSpot…)",
    "pricing.team.feat6": "450 AI credits / month (vs 80)",
    "pricing.team.feat7": "Priority support within 24h",

    "pricing.enterprise.plan": "Enterprise",
    "pricing.enterprise.price": "Custom pricing",
    "pricing.enterprise.feat1": "Everything in Team",
    "pricing.enterprise.plusLabel": "Plus, on top of Team",
    "pricing.enterprise.feat2": "Custom AI credit volume (vs 450)",
    "pricing.enterprise.feat3": "Custom industry vocabulary",
    "pricing.enterprise.feat4": "Multi-team / multi-sector",
