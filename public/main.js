...
const T = {
  fr: {
    ...
    "pricing.business.feat4":
      "Génération de synthèse illimités par jour (Jusqu'à 90 jours d'historique)",
    ...
    "pricing.team.seats": "À partir de 1 commercial",
    "pricing.pro.plan": "Pro Team",
    "pricing.pro.per": "par utilisateur par mois",
    "pricing.pro.groupRep": "Pour chaque commercial",
    "pricing.pro.groupManager": "Pour le manager",
    "pricing.pro.groupShared": "Pour tous",
    "pricing.pro.featApp": "Application mobile iOS & Android",
    "pricing.pro.featReports": "Rapports structurés (via crédits)",
    "pricing.pro.featRecording": "Jusqu'à 45 min d'enregistrement par rendez-vous",
    "pricing.pro.featSyntheses": "Synthèses stratégiques (via crédits)",
    "pricing.pro.featManagerHub": "Rapports, synthèses et stats de toute l'équipe",
    "pricing.pro.featCreditsShared": "80 crédits IA / mois par utilisateur",
    "pricing.pro.featMaxAll": "Max — assistant IA (mobile + hub web)",
    "pricing.pro.featPacks": "Packs de crédits supplémentaires (à partir de 19,90€)",
    "pricing.pro.featSupport": "Support email",
    "pricing.pro.cta": "Essayer gratuitement →",
    ...
    "pricing.team.feat4": "Analyse des rapports des commerciaux par IA",
    "pricing.team.feat5":
  ...
  en: {
    ...
    "pricing.business.feat4":
      "Unlimited weekly syntheses (up to 90 days of history)",
    ...
    "pricing.team.seats": "From 1 sales rep",
    "pricing.pro.plan": "Pro Team",
    "pricing.pro.per": "per user per month",
    "pricing.pro.groupRep": "For each sales rep",
    "pricing.pro.groupManager": "For the manager",
    "pricing.pro.groupShared": "For everyone",
    "pricing.pro.featApp": "iOS & Android mobile app",
    "pricing.pro.featReports": "Structured reports (credit-metered)",
    "pricing.pro.featRecording": "Up to 45 min of recording per meeting",
    "pricing.pro.featSyntheses": "Strategic syntheses (credit-metered)",
    "pricing.pro.featManagerHub": "Reports, syntheses and stats across the entire team",
    "pricing.pro.featCreditsShared": "80 AI credits / month per user",
    "pricing.pro.featMaxAll": "Max — AI assistant (mobile + web hub)",
    "pricing.pro.featPacks": "Top-up credit packs (from €19.90)",
    "pricing.pro.featSupport": "Email support",
    "pricing.pro.cta": "Try free →",
