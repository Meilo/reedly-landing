...
const T = {
  fr: {
    ...
    "features.lead":
      "Reedly automatise tout le compte-rendu terrain, de la parole captée en clientèle au rapport prêt à décider. Votre seule tâche : appuyer sur Enregistrer.",
    "features.card1.title": "Captation terrain, mains libres",
    "features.card1.text":
      "Lancez l'enregistrement avant d'entrer chez le client. Reedly capte le rendez-vous en arrière-plan, mains libres, et continue même hors-ligne. La synchronisation se fait dès le retour du réseau.",
    ...
    "hero.kicker": "[Cible : directions commerciales]",
    "hero.title": "[Titre hero, promesse direction.<br /><em>À valider.</em>]",
    "hero.sub":
      "[Sous-titre hero : ce que la direction gagne à voir tous les RDV terrain de son équipe. À valider en passe copy.]",
    "hero.trust1": "[Réassurance 1 à valider]",
    "hero.trust2": "[Réassurance 2 à valider]",
    "hero.see_demo": "Voir la démo interactive",
    "nav.demo": "Démo interactive",
    "cta.book_demo": "Réserver une démo",
    "cta.title": "[Titre CTA final à valider]",
    "cta.sub": "[Sous-titre CTA final orienté direction à valider.]",
    "logos.caption": "[Légende confiance à valider]",
    "logos.placeholder": "logo client",
    "pricing.title": "[Titre tarifs, prix d'équipe.<br /><em>À valider.</em>]",
    "pricing.lead":
      "[Sous-titre tarifs : prix par équipe, facturé à l'organisation. La démo reste le point d'entrée. À valider.]",
    "pricing.team.badge": "Le plus choisi",
    "pricing.team.plan": "Équipe",
    "pricing.team.subtitle": "À partir de [X] commerciaux · facturé à l'organisation",
    ...
    "pricing.large.subtitle": "[X]+ commerciaux · intégration CRM",
    "pricing.large.price": "Sur devis",
    "pricing.large.feat1": "Tout le plan Équipe",
    "pricing.large.feat2": "Connecteur CRM (HubSpot, Salesforce…)",
    "pricing.large.feat3": "Accompagnement au déploiement",
    "pricing.large.feat4": "Facturation annuelle",
    "pricing.book_demo": "Réserver une démo →",
    "pricing.contact_us": "Nous contacter →",
    "pricing.note": "[Note tarifs, ex. essai après la démo, à valider.]",
    "bookdemo.eyebrow": "Réserver une démo",
    "bookdemo.title": "[Titre section démo à valider]",
    "bookdemo.lead":
      "[Sous-titre : ce que la direction verra pendant la démo. À valider en passe copy.]",
    "bookdemo.intro": "[Paragraphe valeur orienté direction. À valider en passe copy.]",
    ...
    "bookdemo.hint": "[Réassurance sous le formulaire à valider]",
    "bookdemo.calendar": "[ Embed calendrier · Cal.com / Calendly à brancher ]",
  ...
  en: {
    ...
    "features.lead":
      "Reedly automates the entire field report, from the words captured with your client to a decision-ready report. Your only task: press Record.",
    "features.card1.title": "Hands-free field capture",
    "features.card1.text":
      "Start recording before you walk in to see the client. Reedly captures the meeting in the background, hands-free, and keeps going even offline. It syncs the moment you're back online.",
    ...
    // ── Sales-led restructure: overrides + new keys (placeholders to finalize in copy pass) ──
    "hero.kicker": "[Target: sales leadership]",
    "hero.title": "[Hero headline, leadership promise.<br /><em>TBD.</em>]",
    "hero.sub":
      "[Hero subtitle: what leadership gains from seeing every field meeting of their team. TBD in copy pass.]",
    "hero.trust1": "[Reassurance 1 TBD]",
    "hero.trust2": "[Reassurance 2 TBD]",
    "hero.see_demo": "See the interactive demo",
    "nav.demo": "Interactive demo",
    "cta.book_demo": "Book a demo",
    "cta.title": "[Final CTA headline TBD]",
    "cta.sub": "[Final CTA subtitle, leadership-oriented, TBD.]",
    "logos.caption": "[Trust caption TBD]",
    "logos.placeholder": "client logo",
    "pricing.title": "[Pricing headline, team pricing.<br /><em>TBD.</em>]",
    "pricing.lead":
      "[Pricing subtitle: priced per team, billed to the organization. The demo stays the entry point. TBD.]",
    "pricing.team.badge": "Most chosen",
    "pricing.team.plan": "Team",
    "pricing.team.subtitle": "From [X] reps · billed to the organization",
    ...
    "pricing.large.subtitle": "[X]+ reps · CRM integration",
    "pricing.large.price": "Custom quote",
    "pricing.large.feat1": "Everything in Team",
    "pricing.large.feat2": "CRM connector (HubSpot, Salesforce…)",
    "pricing.large.feat3": "Deployment support",
    "pricing.large.feat4": "Annual billing",
    "pricing.book_demo": "Book a demo →",
    "pricing.contact_us": "Contact us →",
    "pricing.note": "[Pricing note, e.g. trial after the demo, TBD.]",
    "bookdemo.eyebrow": "Book a demo",
    "bookdemo.title": "[Demo section headline TBD]",
    "bookdemo.lead":
      "[Subtitle: what leadership will see during the demo. TBD in copy pass.]",
    "bookdemo.intro": "[Leadership-oriented value paragraph. TBD in copy pass.]",
    ...
    "bookdemo.sector.ph": "[Industry]",
    "bookdemo.email.label": "Work email",
    "bookdemo.email.ph": "you@your-organization.com",
    "bookdemo.submit": "See available slots →",
    "bookdemo.hint": "[Reassurance under the form TBD]",
    "bookdemo.calendar": "[ Calendar embed · Cal.com / Calendly to wire ]",
