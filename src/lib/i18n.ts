...
const fr: Dict = {
  ...
  'app.status.time_report': '08:13',
  'app.status.time_record': '08:21',
  'app.report.title': 'Rapport',
  'app.report.summary_label': 'Résumé du rendez-vous',
  'app.report.summary':
    "Priorité absolue : relancer Horizon Voyage sur le Pérou en urgence. Levier : les nouvelles conditions d'annulation à 30 jours et une formation sécurité en septembre pour rassurer l'équipe. Point critique : les délais de réponse du service réservation (3‑4 jours) font fuir les clients vers la concurrence. À traiter en interne sans délai.",
  'app.report.profile_title': "Profil de l'agence",
  'app.report.profile_label': 'Profil commercial',
  'app.report.profile_value': 'Dormant',
  'app.report.profile_badge': '~ Inféré',
  'app.report.context_title': 'Contexte commercial',
  'app.report.context':
    "Agence lyonnaise spécialisée en Amérique du Sud, actuellement en difficulté sur le Pérou suite aux troubles politiques du printemps 2026. Volume annuel Pérou passé de 40 dossiers à moins de 20 cette année. Problème structurel de délais de réponse (3‑4 jours) au service réservation, malgré un recrutement récent.",
  'app.report.publish': 'Publier',
  'app.report.share': 'Partager',
  'app.record.title': 'Enregistrement',
  'app.record.status': 'Enregistrement en cours…',
  'app.record.timer': '02:59',
  'app.report.alt': 'Compte rendu structuré généré par Reedly',
  'app.record.alt': "Écran d'enregistrement de l'app Reedly",
  ...
  'hub.benefit1.text':
    'Tous les retours de vos commerciaux réunis au même endroit : <b>attentes des clients, freins à la vente, opportunités et signaux en faveur de la concurrence.</b>',
  ...
  'hub.benefit3.text':
    "<b>Identifiez</b> les causes d'un ralentissement des ventes, d'un stop vente ou du<b> désengagement d'un compte.</b>",
  ...
  'bookdemo.sector.travel': 'Tourisme & voyage',
  'bookdemo.sector.industry': 'Industrie & BTP',
  'bookdemo.sector.retail': 'Distribution & retail',
  'bookdemo.sector.services': 'Services & conseil',
  'bookdemo.sector.health': 'Santé & médical',
  ...
  'pricing.lead':
    "Facturé à votre organisation, à la taille réelle de l'équipe qui couvre votre terrain.",
  'pricing.billing.monthly': 'Mensuel',
  'pricing.billing.annual': 'Annuel (-14%)',
  'pricing.billing.aria': 'Facturation',
  'pricing.currency.aria': 'Devise',
  'pricing.currency.eur': 'EUR',
  ...
  'faq.q1': 'À qui Reedly s\'adresse-t-il ?',
  'faq.a1':
    "Aux équipes commerciales qui vendent en face à face, sur un portefeuille de points de vente ou de comptes à visiter : tourisme, industrie, distribution, services. Et aux directions commerciales qui veulent savoir, compte par compte, ce qui se dit vraiment sur le terrain, sans multiplier les réunions de reporting.",
  'faq.q2': "L'app fonctionne-t-elle hors connexion ?",
  'faq.a2':
    "Oui. Votre commercial mène son rendez-vous sans réseau, chez le client comme sur la route : l'app tient hors ligne. La transcription et le compte rendu, eux, font appel à nos modèles IA et ont besoin d'une connexion. Ils se génèrent automatiquement dès que le réseau revient.",
  'faq.q3': 'En combien de temps le compte rendu est-il prêt ?',
  'faq.a3':
    "Moins de 2 minutes après une visite d'une heure. Votre commercial repart du rendez-vous avec un compte rendu déjà structuré en 11 sections, avant même de reprendre la route vers le client suivant.",
  ...
  'faq.a5':
    "Le Hub est l'interface web réservée aux managers et aux directions commerciales. Il réunit tous les comptes rendus de vos commerciaux, les synthèses par territoire ou par région, et l'activité de chaque membre de l'équipe. Les commerciaux n'utilisent que l'app mobile ; le Hub est votre poste de pilotage. Il est inclus dans le plan Équipe.",
  'faq.q6': 'La transcription tient-elle dans un environnement bruyant ?',
  'faq.a6':
    "Oui. Reedly s'appuie sur des modèles entraînés sur des conditions réelles : un accueil animé, un comptoir, un showroom, plusieurs voix en même temps. C'est pensé pour une visite client, pas pour un bureau silencieux.",
...
const en: Dict = {
  ...
  'app.status.time_report': '08:13',
  'app.status.time_record': '08:21',
  'app.report.title': 'Report',
  'app.report.summary_label': 'Meeting summary',
  'app.report.summary':
    "Top priority: win Horizon Voyage back on Peru, urgently. Lever: the new 30-day cancellation terms and a September safety training to reassure the team. Critical point: the booking desk's response times (3‑4 days) are pushing clients to competitors. To be handled internally, without delay.",
  'app.report.profile_title': 'Agency profile',
  'app.report.profile_label': 'Commercial profile',
  'app.report.profile_value': 'Dormant',
  'app.report.profile_badge': '~ Inferred',
  'app.report.context_title': 'Commercial context',
  'app.report.context':
    'Lyon-based agency specialising in South America, currently struggling on Peru after the political unrest of spring 2026. Annual Peru volume down from 40 bookings to under 20 this year. Structural response-time problem (3‑4 days) at the booking desk, despite a recent hire.',
  'app.report.publish': 'Publish',
  'app.report.share': 'Share',
  'app.record.title': 'Recording',
  'app.record.status': 'Recording in progress…',
  'app.record.timer': '02:59',
  'app.report.alt': 'Structured report generated by Reedly',
  'app.record.alt': 'Reedly app recording screen',
  ...
  'hub.benefit1.text':
    "Every rep's field feedback in one place: <b>what clients expect, what blocks sales, opportunities, and signals favoring the competition.</b>",
  ...
  'hub.benefit3.text':
    '<b>Identify</b> what is behind a sales slowdown, a stop-sale, or<b> an account disengaging.</b>',
  'hub.max.url': 'hub.reedly.ai/max',
  ...
  'bookdemo.sector.travel': 'Travel & tourism',
  'bookdemo.sector.industry': 'Industry & construction',
  'bookdemo.sector.retail': 'Distribution & retail',
  'bookdemo.sector.services': 'Services & consulting',
  'bookdemo.sector.health': 'Health & medical',
  ...
  'pricing.lead':
    'Billed to your organization, at the real size of the team that covers your territory.',
  'pricing.billing.monthly': 'Monthly',
  'pricing.billing.annual': 'Yearly (-14%)',
  'pricing.billing.aria': 'Billing',
  'pricing.currency.aria': 'Currency',
  'pricing.currency.eur': 'EUR',
  'pricing.currency.usd': 'USD',
  ...
  'pricing.team.feat6': 'Auto-enriched client records',
  ...
  'faq.a1':
    "For sales teams that sell face to face, across a portfolio of outlets or accounts to visit: travel, industry, distribution, services. And for sales leadership who want to know, account by account, what's really being said in the field, without piling on reporting meetings.",
  'faq.q2': 'Does the app work offline?',
  'faq.a2':
    "Yes. Your rep runs the meeting with no network, at the client or on the road: the app holds offline. Transcription and the report do call our AI models, so they need a connection. Both generate automatically as soon as the network is back.",
  'faq.q3': 'How fast is the report ready?',
  'faq.a3':
    'Under 2 minutes after a one-hour visit. Your rep leaves the meeting with a report already structured into 11 sections, before even driving to the next client.',
  ...
  'faq.a5':
    "The Hub is the web interface reserved for managers and sales leadership. It brings together every rep's reports, syntheses by territory or region, and each team member's activity. Reps use only the mobile app; the Hub is your control center. It's included in the Team plan.",
  'faq.q6': 'Does transcription hold up in a noisy environment?',
  'faq.a6':
    "Yes. Reedly relies on models trained on real-world conditions: a busy front desk, a counter, a showroom, several voices at once. It's built for a client visit, not a quiet office.",
